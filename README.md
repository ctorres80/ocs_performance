...
The OpenShift Data Foundation deployment is based on version 4.7 (RC), the ODF operator container image is `image: quay.io/rhceph-dev/ocs-registry:latest-4.7` 
### Enable operator
